...
<div class="container">
  <form method="post" action="{{action('CRUDController@update', $id)}}">
    ...
    <div class="form-group row">
      <label for="smFormGroupInput" class="col-sm-2 col-form-label col-form-label-sm">From :</label>
      <div class="col-sm-10">
        <input type="date" name="from">{{$crud->from}}
      </div>
    </div>
    <div class="form-group row">
      <label for="smFormGroupInput" class="col-sm-2 col-form-label col-form-label-sm">To :</label>
      <div class="col-sm-10">
        <input type="date" name="to">{{$crud->to}}
      </div>
    </div>
    <div class="form-group row">
